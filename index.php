            ...
            <div class="row center-row">
                <div class="col" style="padding:0;">
                    ...
                    <div class="troll-profile-div">
                        ...
                        <div class="reviews">
                            <div class="row reviews-title-row">
                                <div class="col reviews-title-col text-center" style="color: white; margin-bottom: 20px;">
                                    <h3>Reviews</h3>
                                </div>
                            </div>
                            <div class="row review-types">
                                <div class="col funny-reviews-col text-center text-center">
                                    <div class="funny-reviews-section rev-sect">
                                        <h2 class="funny-label" style="color: green;">Funny</h2>
                                        <h2 class="funny-number" style="color: white;">0</h2>
                                    </div>
                                </div>
                                <div class="col neutral-reviews-col text-center">
                                    <div class="neutral-reviews-section rev-sect">
                                        <h2 class="neutral-label" style="color: yellow;">Neutral</h2>
                                        <h2 class="neutral-number" style="color: white;">0</h2>
                                    </div>
                                </div>
                                <div class="col mal-reviews-col text-center">
                                    <div class="mal-reviews-section rev-sect">
                                        <h2 class="mal-label" style="color: red;">Malicous</h2>
                                        <h2 class="mal-number" style="color: white;">0</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
